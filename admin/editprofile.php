                ...
                <div class="x_content">
                  ...
                  <form action="proses/proses_editprofile.php" method="post" enctype="multipart/form-data" name="updateadmin" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input value="<?php echo $data['username_admin']; ?>" type="text" onkeyup="validUsername(this)" id="username_admin" name="username_admin" required="required" maxlength="50" placeholder="Masukkan Username Admin" class="form-control col-md-7 col-xs-12">
                        <br>*Username hanya huruf dan angka yang diizinkan!</br>
                      </div>
                    </div>
                    <div class="form-group">

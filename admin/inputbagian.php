          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>
                    <li class="fa fa-user-plus"></li> Tambah User
                  </h2>
                  <div class="clearfix"></div>
                </div>
                <div class="x_content">
                  ...
                  <form action="proses/proses_inputbagian.php" name="formbagian" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" onkeyup="validUsername(this)" id="username_admin_bagian" name="username_admin_bagian" required="required" maxlength="50" placeholder="Masukkan Username Bagian" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        <a href="databagian.php" class="btn btn-success"><i class="fa fa-chevron-left"></i> Batal</a>
                        <button type="submit" name="input" value="Simpan" class="btn btn-primary"><i class="fa fa-floppy-o"></i> Simpan</button>
                      </div>
                    </div>

          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>
                    <li class="fa fa-user"></li> Data User
                  </h2>
                  <div class="clearfix"></div>
                </div>
                <a href="inputbagian.php"><button type="button" class="btn btn-primary"><i class="fa fa-user-plus"></i> Tambah User</button></a>
                <div class="x_content">
                  <div class="x_content">
                    <?php
                      ...
                      <table id="datatable" class="table table-striped table-bordered">
                        <thead>
                          <tr>
                            ...
                            <th style="text-align:center;" width="15%">Nama Bagian</th>

<?php
    ...
    if (!($tgl_keluar=='') and !($nomor_suratkeluar =='') and !($nama_bagian =='') and !($tgl_surat =='') and !($kepada_suratkeluar =='') and !($perihal_suratkeluar =='') and !($operator =='') and !($tanggal_entry =='') and   
		...
		$sql = "INSERT INTO tb_suratkeluar(tanggalkeluar_suratkeluar, nomor_suratkeluar, nama_bagian, tanggalsurat_suratkeluar, kepada_suratkeluar, perihal_suratkeluar, file_suratkeluar, operator, tanggal_entry)
				values ('$tgl_keluar', '$nomor_suratkeluar', '$nama_bagian', '$tgl_surat', '$kepada_suratkeluar', '$perihal_suratkeluar', '$nama_baru', '$operator', '$tanggal_entry')";
		$execute = mysqli_query($db, $sql);
		
		echo "<script>alert('Surat Keluar berhasil diinput!')</script>

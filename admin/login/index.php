      ...
      <div class="animate form login_form">
        <section class="login_content">
          <form action="proses_login.php" id="login" name="login" method="post">
            ...
            <div>
              <a href="../../index.php"><button type="button" class="btn btn-success"><span class=""></span> Kembali</button></a>
              <button type="submit" class="btn btn-primary"><span class=""></span> Masuk</button>
            </div>
            ...
            <div class="separator">
              <div>
                <!-- <h2><i class="fa fa-institution"></i> PEMERINTAH DESA PARAKAN </h2> -->

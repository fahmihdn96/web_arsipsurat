          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>
                    <li class="fa fa-envelope"></li> Data Surat Masuk
                  </h2>
                  <div class="clearfix"></div>
                </div>
                <form action="downloadlaporan_suratmasuk.php" name="download_suratmasuk" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                  ...
                  <div class="col-md-2 col-sm-2 col-xs-6">
                    <select name="tahun" class="select2_single form-control" tabindex="-1">
                      ...
                      <?php
                      for ($tahun = 2018; $tahun <= 2021; $tahun++) {
                  ...
                  <a href="inputsuratmasuk.php"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Surat Masuk</button></a>
                </form>
                <div class="x_content">
                  <div class="x_content">
                    <?php
                    include '../koneksi/koneksi.php';
                    $sql1      = "SELECT * FROM tb_suratmasuk ORDER BY	id_suratmasuk DESC";
                    ...
                    if ($jumlah == 0) {
                      ...
                      <table id="datatable" class="table table-striped table-bordered">
                        <thead>
                          <tr>
                            <th style="text-align:center;" width="15%">Tanggal Diterima</th>
                            <th style="text-align:center;" width="15%">Pengirim</th>
                            <th style="text-align:center;" width="15%">Kepada</th>
                            <th style="text-align:center;" width="25%">Perihal</th>

          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>
                    <li class="fa fa-envelope"></li> Data Surat Keluar
                  </h2>
                  <div class="clearfix"></div>
                </div>
                <form action="downloadlaporan_suratkeluar.php" name="download_suratkeluar" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                  ...
                  <a href="inputsuratkeluar.php"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Surat Keluar</button></a>
                </form>
                <div class="x_content">
                  <div class="x_content">
                    <?php
                    ...
                    if ($total == 0) {
                      ...
                      <table id="datatable" class="table table-striped table-bordered">
                        <thead>
                          <tr>
                            <th style="text-align:center;" width="15%"> Tanggal Keluar </th>
                            <th style="text-align:center;" width="15%"> Nomor Surat </th>
                            <th style="text-align:center;" width="15%"> Bagian</th>

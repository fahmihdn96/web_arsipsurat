                ...
                <div class="x_content">
                  ...
                  <form action="proses/proses_inputsuratmasuk.php" name="formsuratmasuk" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    if ($jumlah = 0) {
                      ...
                      $nomormax = substr($nomor, 0000000, 7);
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input value="<?php echo "$nomorbaru" ?>" type="text" onkeyup="validAngka(this)" id="nomorurut_suratmasuk" name="nomorurut_suratmasuk" required="required" maxlength="7" placeholder="Masukkan Nomor Urut Surat" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" id="sifat_surat" name="sifat_surat" required="required" maxlength="35" placeholder="Masukkan Sifat Surat" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <textarea id="catatan" name="catatan" required="required" placeholder='Masukkan Catatan Disposisi' class="form-control" rows="3"></textarea>
                      </div>
                    </div>
                    <!-- End Disposisi -->
                    <div class="form-group">

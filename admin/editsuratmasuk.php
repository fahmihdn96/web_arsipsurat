                ...
                <div class="x_content">
                  ...
                  <form action="proses/proses_editsuratmasuk.php" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Tanggal Diterima <span class="required">*</span>
                      </label>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input value="<?php echo $data['nomorurut_suratmasuk']; ?>" type="text" onkeyup="validAngka(this)" id="nomorurut_suratmasuk" name="nomorurut_suratmasuk" required="required" maxlength="7" placeholder="Masukkan Nomor Urut Surat" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <!-- Disposisi -->
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name"> Sifat Surat <span class="required">*</span>
                      </label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input value="<?php echo $data['sifat_surat']; ?>" type="text" id="sifat_surat" name="sifat_surat" required="required" placeholder="Masukkan Sifat Surat" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>

                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name"> Disposisi <span class="required">*</span> </label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <select name="diteruskan_kepada" class="select2_single form-control" tabindex="-1">
                          <option value="<?php echo $data['diteruskan_kepada']; ?>"><?php echo $data['diteruskan_kepada']; ?></option>
                          <option></option>
                          <?php include '../koneksi/koneksi.php';
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <textarea id="catatan" name="catatan" required="required" class="form-control" rows="3" placeholder='Masukkan Isi Disposisi'><?php echo $data['catatan']; ?></textarea>
                      </div>
                    </div>
                    <!-- End Disposisi -->

...
$excelku->getActiveSheet()->setCellValue('A5', "Jl. H. Abdul No. 01 Parakan Ciomas 16616 Bogor ");
...
$excelku->getActiveSheet()->getStyle('A2:H6')->getFont()->setSize(12);
...
$excelku->getActiveSheet()->setCellValue('B8', "NO AGENDA");
...
$excelku->getActiveSheet()->getStyle('A8:H9')->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
$excelku->getActiveSheet()->getStyle('A8:H9')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
$excelku->getActiveSheet()->getStyle('A8:H9')->getBorders()->getAllBorders()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
...
while ($data = $query1->fetch_assoc()) {
  ...
  $excelku->getActiveSheet()->getStyle('A10:G' . $baris . '')->getFont()->setName('Calibri');
  $excelku->getActiveSheet()->getStyle('A10:G' . $baris . '')->getFont()->setSize(11);
  ...
  $excelku->getActiveSheet()->getStyle('G10:H' . $baris . '')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
  $excelku->getActiveSheet()->getStyle('A10:H' . $baris . '')->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
  $excelku->getActiveSheet()->getStyle('A10:H' . $baris . '')->getBorders()->getAllBorders()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
}

        ...
        <div class="row">
          <div class="col-md-6 col-sm-6  ">
            <div class="x_panel">
              ...
              $suratmasuk   = mysqli_query($koneksi, "SELECT * FROM tb_suratmasuk WHERE diteruskan_kepada = '" . $_SESSION['nama'] . "'");
              $suratkeluar  = mysqli_query($koneksi, "SELECT * FROM tb_suratkeluar WHERE nama_bagian = '".$_SESSION['nama']."'");
              ?>

        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2> <li class="fa fa-envelope"></li> Disposisi Surat Masuk </h2>
                  <div class="clearfix"></div>
                </div>
                ...
                <div class="x_content">
                  <div class="x_content">
                    ...
                    $sql1    = "SELECT * FROM tb_suratmasuk WHERE diteruskan_kepada = '" . $_SESSION['nama'] . "'";
                      ...
                      <table id="datatable" class="table table-striped table-bordered">
                        <thead>
                          <tr>
                            ...
                            <th style="text-align:center;" width="15%">Sifat Surat</th>
